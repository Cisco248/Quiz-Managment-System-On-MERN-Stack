      ...
      <div className={Style.quiz_page_align}>
        ...
        <div className={Style.right_section}>
          ...
          <div className={Style.question_section}>
            ...
            <input className={Style.qn_style} type="number"/>
          ...
          <div className={Style.delete_button_container}>
            <button type="button" className={Style.delete_button}><svg className={Style.deleteIcon} xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 32 32" fill="#000">
