    ...
    <div>
      <div className={Style.navibar_box}>
        <div className={Style.logo}>
          <Link to={"/"} className={Style.navibar}>
            <img className={Style.navibar_logo} src="./nav-logo.svg" alt="logo" color="#fff"/>
          </Link>
        </div>
        <div className={Style.navibar_text}>
          <div className={Style.text_align}>
            <Link to={"/help"} className={Style.help_text}>
              Help
            ...
            <Link to={"/contact"} className={Style.contact_text}>
              Contact US
